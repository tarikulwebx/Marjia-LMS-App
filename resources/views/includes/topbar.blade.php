...
<nav class="navbar top-navbar navbar-expand-xl navbar-light shadow sticky-top flex-nowrap">
    <div class="container">
        <a class="navbar-brand me-0 me-sm-2" href="{{ url('/') }}">
            <svg version="1.1" width="180" height="40" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <h4 class="text-white fw-bolder sr-only">Marjia-LMS</h4>
        </a>
        <button class="navbar-toggler collapsed ms-auto px-0 px-sm-3" type="button" data-bs-toggle="collapse"
        ...
        <div class="dropdown user-dropdown ml-1">
            <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                ...
                @if (Auth::user())
                    ...
                    @endif" class="img-fluid" alt="profile">
                @else
                    <img src="{{ asset('images/profile-pic.jpg') }}" class="img-fluid" alt="profile">
                @endif
