                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div id="imgPreviewHolder" class="mb-2">
                                    <img src="{{ $blog->thumbnail ? $blog->thumbnail : asset('images/placeholder_600x370.jpg') }}" alt="thumb">
                                </div>
                            ...
                            <div class="col-12 text-end">
                                {!! Form::button('<i class="fa-regular fa-check-circle me-2"></i>Save changes', ['type' => 'submit', 'class' => 'btn btn-primary px-3 rounded-pill']) !!}
                            </div>
                        </div>
