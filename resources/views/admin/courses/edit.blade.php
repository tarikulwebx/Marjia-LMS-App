...
@section('content')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                {!! Form::label('duration', 'Duration') !!}
                                 {!! Form::text('duration', null, ['class' => $errors->has('duration') ? ' form-control is-invalid' : ' form-control', 'placeholder' => 'Duration']) !!}
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                {!! Form::select('student_enrolls[]', $students, $enrolled_students, ['id' => 'multiselectDefinedUsers', 'class' => $errors->has('student_enrolls') ? ' form-control is-invalid d-none' : ' form-control d-none', 'multiple']) !!}
                            ...
                            <div class="col-12 text-end">
                                ...
                                <div class="mt-2">
                                    <small>Last updated on: {{ $course->updated_at }}</small>
                                </div>
                            </div>
                        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">Delete course</h6>
        </div>
        <div class="card-body pb-5">
            <div class="row">
                <div class="col-lg-10 col-xl-8">
                    {!! Form::open(['method' => 'DELETE', 'route' => ['courses.destroy', $course->slug]]) !!}
                        <div class="row g-3">
                            <div class="col-12">
                                <p class="m-0 text-gray-700">After delete this course everything related to this course for example- student enrollments, reviews, lessons will be deleted.</p>
                            </div>
                            <div class="col-md-8 align-self-center">
                                ...
                                <small class="text-danger">{{ $errors->first('delete_agreement') }}</small>
                            </div>
                            <div class="col-md-4">
                                {!! Form::button('<i class="fa-solid fa-trash-alt me-2"></i>Delete Course', ['type' => 'submit', 'class' => 'btn btn-danger text-nowrap px-3 rounded-pill']) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
