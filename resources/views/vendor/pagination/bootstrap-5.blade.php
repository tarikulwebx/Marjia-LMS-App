            ...
            <ul class="pagination w-100 justify-content-between">
                ...
                @if ($paginator->onFirstPage())
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link previous-btn">Previous</span>
                    </li>
                @else
                    <li class="page-item">
                        <a class="page-link previous-btn" href="{{ $paginator->previousPageUrl() }}" rel="prev">Previous</a>
                    </li>
                @endif
                ...
                @if ($paginator->hasMorePages())
                    <li class="page-item ms-auto">
                        <a class="page-link next-btn" href="{{ $paginator->nextPageUrl() }}" rel="next">Next</a>
                    </li>
                @else
                    <li class="page-item ms-auto disabled" aria-disabled="true" >
